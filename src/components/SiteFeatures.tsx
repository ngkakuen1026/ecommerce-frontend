    ...
    <div className="bg-white py-3">
      <div className=" flex flex-col md:flex-row items-center justify-evenly">
        <div className="flex flex-col items-center flex-grow">
          ...
          <p className="font-light italic">Buy and Selling 24/7</p>
        </div>
        <div className="flex flex-col items-center flex-grow md:border-l-2 md:border-gray-300">
          ...
          <p className="font-light italic">Member all around the world</p>
        </div>
        <div className="flex flex-col items-center flex-grow md:border-l-2 md:border-gray-300">
          <CreditCard className="w-8 h-8 md:w-10 md:h-10" />
          <h1 className="text-lg font-bold">100% Payment Secure</h1>
          <p className="font-light italic">Pay with secure payment system</p>
        </div>
      </div>
    </div>
  );
